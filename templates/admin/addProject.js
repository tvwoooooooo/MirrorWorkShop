...
<!-- 选择备份内容的模态框（两步，同时支持 GitHub 和 Docker） -->
<div class="modal-overlay" id="backupContentModal" style="display: none;">
    <div class="modal-content backup-modal-content">
        ...
        <!-- 第一步：选择文件与 Releases（GitHub）或 选择标签（Docker） -->
        <div id="backupStep1" class="backup-step">
            ...
            <!-- GitHub 文件树区域（动态显示/隐藏） -->
            <div id="githubFileSection">
            ...
            <!-- Docker 标签区域（动态显示/隐藏） -->
            <div id="dockerTagSection" style="display: none;">
                <h4 style="margin: 0.5rem 0;">选择要备份的标签</h4>
                <div class="select-all-bar">
                    <input type="checkbox" id="selectAllTags">
                    <label for="selectAllTags">全选所有标签</label>
                    <span style="margin-left: auto;" id="selectedTagsCount">0 个标签</span>
                </div>
                <div id="tagsContainer" class="tags-container">
                    <div class="loading-indicator">加载标签中...</div>
                </div>
            </div>
        </div>
