...
import { markTaskAsProcessing, updateMasterTaskProgress, completeMasterTask } from './taskManager.js';
...
export async function processBatch(batchTask, env) {
    ...
    // 如果是第一个批次，将任务状态从 queued 改为 processing
    if (batchIndex === 0) {
        await markTaskAsProcessing(env, masterTaskId);
    }
