...
import { handleProjects, handleProject, handleRepoTree, handleRepoReleases, handleDetailedProject, handleDockerBackup } from './projects.js';
...
export async function handleAPI(request, env) {
  ...
  if (path === 'docker/backup' && method === 'POST') {
    // 提交 Docker 镜像备份任务
